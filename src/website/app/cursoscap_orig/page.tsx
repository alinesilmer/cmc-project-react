...
const mockCursos: Curso[] = [
  {
    id: "c1",
    titulo: "Actualización en Medicina Interna 2025",
    resumen: "Casos clínicos, algoritmos de diagnóstico y revisión de guías.",
    fecha: "2025-12-03",
    duracionHs: 12,
    modalidad: "Presencial",
    categoria: "Actualización",
    imagen: "https://picsum.photos/seed/cmc-course1/1200/675",
    cupos: 30,
    precio: 0,
    lugar: "Sede Central CMC",
    ...
    <div>
      <div>
        <Hero
          ...
          backgroundImage={
            "https://res.cloudinary.com/dcfkgepmp/image/upload/v1762395219/20251105_2312_Medical_Tools_and_Books_simple_compose_01k9bew997e1btmrgfcs27m37g_gkzulx.png"
          }
        />
      </div>
      ...
      <section className={styles.wrapper} aria-label="Cursos y Capacitaciones">
        <div className={styles.controls}>
          ...
          <div className={styles.pills}>
            ...
            <button
              className={`${styles.pill} ${
                cat === "Actualización" ? styles.active : ""
              }`}
              onClick={() => setCat("Actualización")}
            >
              Actualización
            </button>
            <button
              className={`${styles.pill} ${
                cat === "Gestión" ? styles.active : ""
              }`}
              onClick={() => setCat("Gestión")}
            >
              Gestión
            </button>
            <button
              className={`${styles.pill} ${
                cat === "Ética" ? styles.active : ""
              }`}
              onClick={() => setCat("Ética")}
            >
              Ética
            </button>
            <button
              className={`${styles.pill} ${
                cat === "Tecnología" ? styles.active : ""
              }`}
              onClick={() => setCat("Tecnología")}
            >
              Tecnología
            </button>
          </div>
            ...
            <div className={styles.toggleGroup}>
              <button
                className={`${styles.toggle} ${
                  mod === "Todas" ? styles.tActive : ""
                }`}
                onClick={() => setMod("Todas")}
              >
                Todas
              </button>
              <button
                className={`${styles.toggle} ${
                  mod === "Presencial" ? styles.tActive : ""
                }`}
                onClick={() => setMod("Presencial")}
              >
                Presencial
              </button>
              <button
                className={`${styles.toggle} ${
                  mod === "Online" ? styles.tActive : ""
                }`}
        ...
        {noHayCursos ? (
          <div className={styles.empty}>
            ...
            <p className={styles.emptyText}>
              Próximamente publicaremos nuevas actividades de formación
            </p>
          </div>
        ) : (
          <>
