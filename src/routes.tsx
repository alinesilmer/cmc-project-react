    ...
    <AnimatePresence mode="wait">
      <Routes>
        ...
        <Route element={<RequireAuth />}>
          ...
          <Route path="/panel/liquidation/:id" element={<LiquidationCyclePage />} />
          <Route path="/panel/padron-ioscor" element={<PadronIoscor />} />
          <Route path="/panel/liquidation/:id/debitos" element={<DiscountsPage />} />
          <Route path="/panel/liquidation/:id/insurance/:osId/:period/:liquidacionId" element={<InsuranceDetail />} />
          <Route path="/panel/solicitudes" element={<ApplicationsList />} />
          <Route path="/panel/solicitudes/:id" element={<ApplicationDetail />} />
          <Route path="/panel/users" element={<UsersList />} />
          <Route path="/panel/register-socio" element={<RegisterSocio />} />
          <Route path="/panel/admin/permissions" element={<PermissionsManager />} />
          <Route path="/panel/users-manager" element={<UsersManagerDashboard />} />
